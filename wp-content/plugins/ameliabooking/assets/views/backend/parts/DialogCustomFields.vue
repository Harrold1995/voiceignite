  ...
  <div class="am-dialog-table am-custom-fields-container">
    ...
    <div v-for="(booking, key) in appointment.bookings" class="am-customer-extras">
      ...
      <div class="am-custom-fields">
        ...
        >
          <span v-if="(customField.type === 'checkbox' || customField.type === 'radio') && customField.label" v-html="customField.label ? '<label class=' + '\'el-form-item__label\'>' + customField.label + '</label>' + ':' : ''"></span>
