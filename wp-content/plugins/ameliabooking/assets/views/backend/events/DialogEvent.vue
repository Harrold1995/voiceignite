        ...
        <el-tabs v-model="defaultEventTab">
          ...
          <el-tab-pane :label="$root.labels.pricing" name="pricing">
            ...
            <div class="am-pricing">
              ...
              <div>
                <el-row :gutter="10" v-if="event.maxCapacity > 1 || getTicketsSpots() > 1">
              ...
              <div>
                <div class="am-setting-box am-switch-box" style="margin-top: 20px;">
                  ...
                  <el-row v-if="(event.maxCapacity > 1 || getTicketsSpots() > 1) && depositPayment === 'fixed' && depositEnabled">
                    <el-col>
                  ...
                  <el-row :style="{flexWrap: 'wrap'}">
                    <el-col :style="{marginBottom: '12px'}" class="am-event-ticket-row">
                      ...
                      >
                        ...
                        <el-col :span="7"><el-input-number :style="{marginBottom: '0px', textAlign: 'center'}" v-model="ticket.spots" @change="ticket.spots = ticket.spots <= 0 ? 1 : ticket.spots" size="small" :min="1"></el-input-number></el-col>
            ...
            if (dateRanges.length) {
              dateRanges.forEach(dtrange => {
                this.customTicketsDateRange.push({
                  ...
                  range: {
                    start: new Date(dtrange.startDate),
                    end: new Date(dtrange.endDate)
                  }
                })
              })
            }
